...
class BlogAdminController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        // $blog->update($request->only(['title', 'slug', 'tag', 'short_description', 'long_description', 'image', 'status']));
    ...
    public function updateComment(Request $request, $id)
    {
        ...
        $comment->update($request->only(['content', 'status', 'is_accept', 'report_count']));
        // dd($comment);
