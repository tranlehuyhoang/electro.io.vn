                        ...
                        <div class="sa-inbox-list__item"><label class="sa-inbox-list__checkbox"><input type="checkbox"
                            ...
                            <div class="sa-inbox-list__author">
                                <div class="sa-symbol sa-symbol--shape--circle">
                                    <div class="sa-symbol__text">{{ $user->id }}</div>
                                </div>{{ $user->name }}
                            </div>
                            <div class="sa-inbox-list__summary">
                                <div class="sa-inbox-list__badges"><span
                                        class="badge badge-sa-info">{{ $user->otp }}</span></div>
                                <div class="sa-inbox-list__content"><span class="sa-inbox-list__subject"><a
                                            href="{{ route('admin.inbox.id', ['id' => $user->id]) }}">Thank you for choosing
                                            Electro online
                                            shopping. Use the following OTP to complete your Sign Up procedures. OTP is
                                            valid for 5 minutes</a></span> – <span class="sa-inbox-list__title">It is
                                        debated as to whether Metaphilosophy is a subject that comes prior to philosophy or
                                        whether it is inherently part of philosophy.</span></div>
                            </div>
                            <div class="sa-inbox-list__date">{{ $user->created_at->format('d M') }}</div>
                        </div>
                    @endforeach
