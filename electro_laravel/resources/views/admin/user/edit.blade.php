                ...
                <div class="py-5">
                    <div class="row g-4 align-items-center">
                        <div class="col">
                            ...
                            <h1 class="h3 m-0">Tạo người dùng mới</h1>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body p-5">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group input-group--sa-slug">
                                            <input name="wallet" value="{{ optional($user->wallet)->balance ?? 0 }}" type="text" class="form-control" id="form-user/wallet" maxlength="8" limit="8"/>
                                            @error('wallet')
                                               {{$message}}
                                            @enderror
                                        </div>
