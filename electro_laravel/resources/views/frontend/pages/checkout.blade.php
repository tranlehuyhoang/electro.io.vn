                ...
                <div class="card border-0">
                    ...
                    <div id="shopCartTwo" class="collapse border border-top-0" aria-labelledby="shopCartHeadingTwo"
                        ...
                        @if (session('success'))
                            ...
                            @else
                            <div class="alert alert-success">
                                {{ 'You have ' . session('success'). Session::get('discount') . '% discounnt' }}
                            </div>
                        @endif
...
?>
                                                ...
                                                @php
                                                    ...
                                                    $totalShippingCost += $item['shipping_cost']; // Cộng tổng phí vận chuyển của mỗi mục vào totalShippingCost
                                                @endphp
                                            @endforeach
                                        ...
                                        <div id="basicsAccordion1">
                                            ...
                                            <div class="border-bottom border-color-1 border-dotted-bottom">
                                                <div class="p-3" id="basicsHeadingThree">
                                                    <div class="custom-control custom-radio">
                                                        <input {{ (int)$balance < (int)number_format($subtotal + $totalShippingCost - (Session::get('discount') / 100) * ($subtotal + $totalShippingCost), 0, '', '') ? 'disabled' : '' }}
                                                        ...
                                                        <label class="custom-control-label   form-label" for="wallet"
                                                            ...
                                                            aria-expanded="false"
                                                            style="text-decoration: {{ (int)$balance < (int)number_format($subtotal + $totalShippingCost - (Session::get('discount') / 100) * ($subtotal + $totalShippingCost), 0, '', '') ? 'line-through' : '' }}"
                                                            aria-controls="basicsCollapseThree">
                                                           @if ( (int)$balance < (int)number_format($subtotal + $totalShippingCost - (Session::get('discount') / 100) * ($subtotal + $totalShippingCost), 0, '', ''))
                                                           Ví Electro ( ${{ $balance }} ) số dư không đủ
                                                          @else     
                                                          Ví Electro ( ${{ $balance }} )
                    ...
                    <div class="col-lg-7 order-lg-1">
                        <div class="pb-7 mb-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="js-form-message mb-6">
                                        ...
                                        <input type="text" class="form-control" name="zipcode" placeholder="99999"
                            ...
                            <!-- Title -->
                            <div class="border-bottom border-color-1 mb-5">
                                <h3 class="section-title mb-0 pb-2 font-size-25">Lời nhắn vận chuyển</h3>
                            </div>
                            <!-- End Title -->
                            ...
                            <div class="js-form-message mb-6">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control p-5" rows="4" name="text"
                                        placeholder="Vd: Tôi muốn giao trước ngày 11/12."></textarea>
                                </div>
                            </div>
                            <!-- End Input -->
                        </div>
