                    ...
                    <div class="d-none d-xl-block col-xl-5">
                        <ul class="list-inline mb-0">
                            <li
                                ...
                                <a href="tel:0896724944" class="u-header-topbar__nav-link"><i
                                        class="ec ec-phone mr-1"></i> 0896724944</a>
                            </li>
                            <li class="list-inline-item u-header-topbar__nav-item u-header-topbar__nav-item-no-border">
                                <a href="mailto:trangiangzxc@gmail.com" class="u-header-topbar__nav-link"><i
                                        ...
                                        if (products) {
                                            ...
                                            $.each(products, function(index, product) {
                                                ...
                                                var $a = $('<a  >', {
                                                    ...
                                                    "href": '/' + product.slug,
                                                    "html": '<img    data-src="https://electro.io.vn/storage/' + product.image_url +
