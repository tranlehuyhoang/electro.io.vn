<div class="container_ad">
    <div class="advertisement">
        <div class="image-wrapper">
            <img src="{{asset('client/img/blackfriday.webp')}}" id="bg" alt="">
            <a href="{{ route('frontend.category.show', ['product_slug' => $product->slug]) }}" id="buynow" class="btn btn-primary  ">Buy Now</a>
        ...
        <div class="col-md-5 mb-4 mb-md-0" style="position: absolute;width: 500px;">
            ...
            id="sliderSyncingThumb" style="display: none;"
